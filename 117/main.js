...
document.getElmentById('sketch_name').innerHTML = 'Sketch To be Drawn: ' + sketch;
...
function preload() {
    ...
    canvas.center;
    canvas.mosueReleased(classifyCanvas);
}
function setup() {
canvas = createCanvas(280, 280);
canvas.center();
...
function gotResults(error, results) {
    ...
    document.getElementById('confidence').inngerHTML = 'Confidence: ' + Math.round(results[0].confidence * 100) + '%';
}
